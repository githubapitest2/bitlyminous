...
/**
 * The Class SendStatisticsCommand.
 */
public class SendStatisticsCommand extends TwitterScheduledCommand {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
			SERVICE_FACTORY.createTwitterService().sendUrlStatistics();
		} catch (Exception e) {
			logger.log(Level.SEVERE, "Error while sending direct message.", e);
		}		
	}
}
