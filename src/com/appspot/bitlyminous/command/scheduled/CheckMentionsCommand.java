...
/**
 * The Class CheckMentionsCommand.
 */
public class CheckMentionsCommand extends TwitterScheduledCommand {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
			SERVICE_FACTORY.createTwitterService().handleMentions();
		} catch (Exception e) {
			logger.log(Level.SEVERE, "Error while accessing mentions.", e);
		}
	}
