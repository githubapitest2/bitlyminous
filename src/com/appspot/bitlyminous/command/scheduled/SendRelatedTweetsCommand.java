...
/**
 * The Class SendRelatedTweetsCommand.
 */
public class SendRelatedTweetsCommand extends TwitterScheduledCommand {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
			SERVICE_FACTORY.createTwitterService().sendRelatedTweets();
		} catch (Exception e) {
			logger.log(Level.SEVERE, "Error while sending related tweets.", e);
		}
	}
}
