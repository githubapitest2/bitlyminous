...
/**
 * The Class SendPopularLinksCommand.
 */
public class SendPopularLinksCommand extends TwitterScheduledCommand {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
			SERVICE_FACTORY.createTwitterService().sendPopularLinks();
		} catch (Exception e) {
			logger.log(Level.SEVERE, "Error while sending popular links.", e);
		}
	}
}
