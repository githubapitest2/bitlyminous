...
/**
 * The Class SearchTweetsCommand.
 */
public class SearchTweetsCommand extends TwitterScheduledCommand {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
			SERVICE_FACTORY.createTwitterService().searchPublicTimeline();
		} catch (Exception e) {
