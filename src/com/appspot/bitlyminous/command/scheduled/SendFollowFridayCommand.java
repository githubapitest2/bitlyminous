...
/**
 * The Class SendFollowFridayCommand.
 */
public class SendFollowFridayCommand extends TwitterScheduledCommand {
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
			SERVICE_FACTORY.createTwitterService().sendFollowFridays();
		} catch (Exception e) {
			logger.log(Level.SEVERE, "Error while sending follow fridays.", e);
		}
	}
}
